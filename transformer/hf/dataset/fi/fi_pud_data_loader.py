...
_DESCRIPTION = """Finnish PUD treebank"""
_DATA_DIR = "./data/UDv29/languages/Finnish/UD_Finnish-PUD"
_TEST_FILE ="fi_pud-ud-test.conllu"
...
class FinnishPUDTreebankConfig(datasets.BuilderConfig):
  ...
  def __init__(self, **kwargs):
    ...
    """
    super(FinnishPUDTreebankConfig, self).__init__(**kwargs)


class FinnishPUDTreebank(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
      FinnishPUDTreebankConfig(name="FinnishPUDTreebank", version=datasets.Version("1.0.0"),
                              description="Finnish PUD Dependency Treebank"),
    ]
    def _info(self):
