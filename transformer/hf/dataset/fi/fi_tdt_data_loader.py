...
class FinnishTDTTreebankConfig(datasets.BuilderConfig):
  ...
  def __init__(self, **kwargs):
    ...
    """
    super(FinnishTDTTreebankConfig, self).__init__(**kwargs)


class FinnishTDTTreebank(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
      FinnishTDTTreebankConfig(name="FinnishTDTTreebank", version=datasets.Version("1.0.0"),
                              description="Finnish TDT Dependency Treebank"),
    ]
    def _info(self):
