...
_DESCRIPTION = """English PUD treebank"""
_DATA_DIR = "./data/UDv29/languages/English/UD_English-PUD"
_TEST_FILE ="en_pud-ud-test.conllu"
...
class EnglishPUDTreebankConfig(datasets.BuilderConfig):
  ...
  def __init__(self, **kwargs):
    ...
    """
    super(EnglishPUDTreebankConfig, self).__init__(**kwargs)


class EnglishPUDTreebank(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
      EnglishPUDTreebankConfig(name="EnglishPUDTreebank", version=datasets.Version("1.0.0"),
                              description="English PUD Dependency Treebank"),
    ]
    def _info(self):
