...
_DESCRIPTION = """Chinese GSD treebank"""
_DATA_DIR = "./data/UDv29/languages/Chinese/UD_Chinese-GSD"
...
class ChineseGSDTreebankConfig(datasets.BuilderConfig):
  ...
  def __init__(self, **kwargs):
    ...
    """
    super(ChineseGSDTreebankConfig, self).__init__(**kwargs)


class ChineseGSDTreebank(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
      ChineseGSDTreebankConfig(name="ChineseGSDTreebank", version=datasets.Version("1.0.0"),
                              description="Chinese GSD Dependency Treebank"),
    ]
    def _info(self):
