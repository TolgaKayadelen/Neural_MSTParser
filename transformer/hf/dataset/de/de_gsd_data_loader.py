...
class GermanGSDTreebankConfig(datasets.BuilderConfig):
  ...
  def __init__(self, **kwargs):
    ...
    """
    super(GermanGSDTreebankConfig, self).__init__(**kwargs)


class GermanGSDTreebank(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
      GermanGSDTreebankConfig(name="GermanGSDTreebank", version=datasets.Version("1.0.0"),
                              description="German GSD Dependency Treebank"),
    ]
    def _info(self):
