...
_DESCRIPTION = """PUD dependency treebank"""
_DATA_DIR = "./data/UDv29/languages/Turkish/PUD"
_TEST_FILE ="tr_pud-ud-test.conllu"
...
class TrPudTreebankConfig(datasets.BuilderConfig):
  ...
  def __init__(self, **kwargs):
    ...
    """
    super(TrPudTreebankConfig, self).__init__(**kwargs)


class BounTreebank(datasets.GeneratorBasedBuilder):
  BUILDER_CONFIGS = [
    TrPudTreebankConfig(name="TrPudTreebank", version=datasets.Version("1.0.0"),
                       description="Tr Pud Dependency Treebank"),
  ]
  def _info(self):
