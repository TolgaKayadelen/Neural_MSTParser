...
class DataTrainingArguments:
  ...
  task_name: Optional[str] = field(default="dep_labels", metadata={"help": "The name of the task (ner, pos...)."})
  ...
  train_file: Optional[str] = field(
    default="./transformer/hf/data/train.csv",
    metadata={"help": "The input training data file (a csv or JSON file)."}
  )
  validation_file: Optional[str] = field(
    default="./transformer/hf/data/dev.csv",
    metadata={"help": "An optional input evaluation data file to evaluate on (a csv or JSON file)."},
  )
  test_file: Optional[str] = field(
    default="transformer/hf/data/test.csv",
...
def main():
  ...
  send_example_telemetry("bert_fine_tuner", model_args, data_args, framework="tensorflow")
  # endregion
  ...
  if data_args.dataset_name is not None:
    ...
    raw_datasets = load_dataset("./transformer/hf/dataset/hf_data_loader.py")
  ...
  elif f"{data_args.task_name}" in column_names:
  ...
  def tokenize_and_align_labels(examples):
    ...
    for i, label in enumerate(examples[label_column_name]):
      ...
      # print("words ", examples[text_column_name][i])
      # input()
