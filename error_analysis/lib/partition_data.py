...
class Partition:
  ...
  def by_construction(self, construction, data_dir, multiclause=False):
    ...
    print(f"total sentences including {construction}: {total_sentence_including_const}")
    print(f"total multiclause_including {construction}: {total_multiclause_including_const}")
    print(f"tokens {construction}: {tokens_marked_with_const}")
    print(f"errors {construction}: {errors_for_const}")
    print()
    print("Error Stats")
    print(f"tokens only label wrong {construction}: {n_only_label_errors}")
    print(f"tokens only head wrong {construction}: {n_only_head_errors}")
    print(f"tokens only head wrong when multiclause {construction}: {n_only_head_errors_when_multiclause}")
    print(f"tokens both wrong {construction}: {n_both_errors}")
    print(f"n_correct_grammatical_role_attached_to_wrong_pred {construction}: {n_correct_grammatical_role_attached_to_wrong_pred}")
    print(f"errors_for_const_in_multiclause {construction}: {errors_for_const_in_multiclause}")
    print()
    print("Sent IDs")
    print(f"multiclause sentences including {construction}: {multiclause_sentences_with_const}")
    print(f"multiclause sentences with errors {construction}: {multiclause_sentences_with_errors}")
    print(f"sent_ids both errors {construction}: {sent_ids_with_both_errors}")
    print(f"sent_ids only label errors {construction}: {sent_ids_only_label_errors}")
    print(f"sent_ids only head errors {construction}: {sent_ids_only_head_errors}")
    print(f"sent_ids only head errors when multiclause {construction}: {sent_ids_only_head_errors_when_multiclause}")
    print(f"sent_ids_correct_grammatical_role_attached_to_wrong_pred {construction}: {sent_ids_correct_grammatical_role_attached_to_wrong_pred}")
    print()
    print("Confusion Types")
    print(f"labels confused when head correct ", labels_confused_when_head_correct)
    print(f"labels confused when both wrong ", labels_confused_when_both_wrong)
    print()
    """
