...
from parser.nn.seq_lstm_labeler import SeqLSTMLabeler
...
if __name__ == "__main__":
  ...
  parser = SeqLSTMLabeler(word_embeddings=prep.word_embeddings,
                         n_output_classes=label_feature.n_values,
                         predict=["labels"],
                         features=["words", "pos", "morph", "dep_labels"],
                         model_name="seq_lstm_labeler_test")
  ...
  train_treebank= "treebank_train_500_1000.pbtxt" # "tr_imst_ud_train_dev.pbtxt"
